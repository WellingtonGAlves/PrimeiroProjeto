...
<div id="dialog_box">
	...
	<div class="content">
		...
		<b>DADOS DO CLIENTE&nbsp;<img border=0 src='../Boltech/imagens/frota.gif' style='height:25px;' title='Frota do cliente' alt='Frota do cliente' href='javascript:void(0)' id='img_mostra_frota' /></b><hr>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="loader-cerca"><img src="/Boltech/imagens/loader.gif" class="img-responsive" alt="Carregando..."></div>
        <div id="mapa-cerca"></div>s
