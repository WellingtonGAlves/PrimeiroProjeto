...
?>
<div class="row">
    <a href="Boltech/javascript:carregarConteudo('#ui-tabs-1', 'ajax/usuarios.php?lista=<?=$anterior?>')" class="btn btn-default">&larr; Voltar Para Lista</a> 
    <a href="Boltech/javascript:carregarConteudo('#ui-tabs-1', 'ajax/usuarios_form.php')" class="btn btn-default"><i class="fa fa-plus-square"></i> Novo Usuário</a>
</div>
...
<h1>Informações usuário</h1>	
    ...
    <div id="veiculos_clientes">
    	<h1>Veículos</h1>
        <a href="Boltech/ajax/veiculo_form.php?cliente_id=<?=$dataCliente['id']?>" class="popupVeiculoForm btn btn-default" id="linkNovoVeiculo" style="margin:10px"><i class="fa fa-truck"></i> Novo Veículo</a>
		<?php if(!empty($id)):?>
        <?php
