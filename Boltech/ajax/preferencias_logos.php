...
<h1>Envio de Logos</h1>		
    <form enctype="multipart/form-data" action="Boltech/ajax/preferencias_logos.php" method="POST" class="form-horizontal" role="form">    
     ...
     <form enctype="multipart/form-data" action="ajax/preferencias_logos.php" method="POST" class="form-horizontal" role="form">    
      ...
      <input name="imgLogoHeader" type="file" class="form-control"/>
                    ...
                    <input type="submit" class="btn btn-success btn-lg" value="Enviar" id="bnLogoHeader" >
                </div>
            </div>
        </fieldset>
    </form>
