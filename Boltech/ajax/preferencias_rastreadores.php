...
$cnx = mysql_connect("localhost", "root", "")  or die("Could not connect: " . mysql_error());
        ...
        <fieldset class="container">
            ...
            <div class="row">
                <div class="form-group col-sm-12 text-center">
                    ...
                    <img style="display:none" src="..Boltech/imagens/executando.gif" id="usuarioFormExecutando">
                    <img id="usuarioFormSucesso" style="display:none" src="..Boltech/imagens/sucesso.png">
...
$("#btnRetirar").click(function(){
	window.location.href="Boltech/ajax/delTracker.php?rastreador="+$("#rastreadoresCadastrados").val();
});
</script>