...
<table>
    ...
    <select name="rastreador">
    	<option value="crx1">CRX 1</option>
        <option value="gt06">GT 06</option>
        <option value="gt06n">GT 06N</option>
        <option value="h02">H02</option>
        <option value="h08">H08</option>
        <option value="tk103">TK 103</option>
        <option value="tk104">TK 104</option>
    </select>
    </td></tr>
    <tr><td>Modelo</td><td>
...
<script type="text/javascript">
	$('#formNovoVeiculo').validate({
        rules: {
            imei: { required: true, minlength: 15 }
        },
        messages: {
