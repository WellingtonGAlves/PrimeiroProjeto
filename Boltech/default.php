...
<head>
  ...
  <title><?php echo EMPRESA . " - Rastreamento de Veículos"; ?></title>
  <link rel="shortcut icon" href="<?php echo LOGO_ADMIN; ?>">
  ...
  <!-- Add custom CSS here -->
  <link href="Boltech/css/sb-admin.css" rel="stylesheet">
  <link rel="stylesheet" href="Boltech/font-awesome/css/font-awesome.min.css">
  <link rel="stylesheet" href="Boltech/css/nova_interface.css" rel="stylesheet">
  <!-- Page Specific CSS -->
  <!-- <link rel="stylesheet" href="http://cdn.oesmith.co.uk/morris-0.4.3.min.css"> -->
  <script type="text/javascript" src="Boltech/javascript/listagemAjax.js"></script>
<style type="text/css">
.bordatable {
	color: #333;
}
...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          ?>
          <li><a href="Boltech/javascript:void(0)"><i class="fa fa-clock-o fa-lg"></i> Hora do Servidor: <b id="clock">09:44</b></a></li>
          <li><a href="Boltech/default.php"><i class="fa fa-refresh fa-lg"></i> Recarregar Página</a></li>
          <li><a href="Boltech/logout.php"><i class="fa fa-power-off fa-lg"></i> Sair do Sistema</a></li>
        </ul>
        ...
        <ul class="nav navbar-nav navbar-right navbar-user">
          ...
          <li class="dropdown veiculos-dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-truck"></i> Veículos <b class="caret"></b></a>
          ...
          <?php if (empty($config) || $config->hodometro): ?>
            <li class="dropdown hodometro-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-dashboard"></i> Hodômetro <b class="caret"></b></a>
              <ul class="dropdown-menu text-center">
                <form action="" method="POST" class="form-inline" role="form">
          ...
          <?php if (empty($config) || $config->comandos): ?>
            <li class="dropdown comandos-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-tasks"></i> Comandos <b class="caret"></b></a>
              <ul class="dropdown-menu text-center">
          ...
          <?php if (empty($config) || $config->cerca): ?>
            <li class="dropdown cerca-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bullseye"></i> Cerca Virtual <b class="caret"></b></a>
          ...
          <?php if (empty($config) || $config->rota): ?>
            <li class="dropdown cerca-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-location-arrow"></i> Rotas <b class="caret"></b></a>
              <ul class="dropdown-menu text-center">
                <form class="form-inline" role="form">
          ...
          <li class="dropdown alerts-dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell"></i> Alertas <span class="badge">0</span> <b class="caret"></b></a>
          ...
          <li class="dropdown user-dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?=$nmCliente?> <b class="caret"></b></a>
            <ul class="dropdown-menu">
            ...
            <div class="row"> 
              <div class="col-lg-9"> 
                <div class="form-group"> 
                  ...
                  <select id="cmbMovimento" name="cmbMovimento" class="form-control">
                                    <option value="0">Todos</option>
                                    <option value="1">Em Movimento</option>
                  </select>
                </div>
              </div>
  ...
  <script src="Boltech/javascript/bootstrap.js"></script>
  <script src="Boltech/javascript/jquery.validate.min.js"></script>
  <script src="Boltech/javascript/bootstrap-waitingfor.js"></script>
  

  <script type="text/javascript" src="http://maps.google.com/maps/api/js?v=3.9&sensor=false&libraries=drawing"></script>
  <script src="Boltech/javascript/markerwithlabel.js" type="text/javascript"></script>
  <script src="Boltech/javascript/polygon.min.js" type="text/javascript"></script>
  <script src="Boltech/javascript/latlong.js" type="text/javascript"></script>
  <script src="Boltech/javascript/geo.js" type="text/javascript"></script>
  <script type="text/javascript">
    ...
    function imprimirHistorico () {
      ...
      mywindow.document.write('<link rel="stylesheet" href="Boltech/css/bootstrap.min.css" type="text/css">');
      ...
      if (imei) {
        $.ajax({
          ...
          success: function (aDados) {
            ...
            if (aDados.length > 1) var_map.setZoom(13);
            else {
