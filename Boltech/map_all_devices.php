...
<script type="text/javascript" src="Boltech/javascript/jquery-1.7.min.js">cv </script>
...
function imagemSinal (sinal) {
  switch (sinal) {
	case 'R':
	  var caminho = 'Boltech/imagens/status_rastreando.png';
	break;

	case 'D':
	  var caminho = 'Boltech/imagens/status_desligado.png';
	break;
     ...
     var marker = new MarkerWithLabel({
		...
		*/
		...
		if (aDados.length > 1) var_map.setZoom(10);
		  ...
		  $.ajax({
			url: "Boltech/menu_hodometro.php",
			type: "GET",
