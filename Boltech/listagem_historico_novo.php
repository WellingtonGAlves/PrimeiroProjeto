...
$query = "
	select date_format(date,'%d/%m/%Y %H:%i:%s') as data, imei, latitudeDecimalDegrees, latitudeHemisphere, longitudeDecimalDegrees, longitudeHemisphere, 
	       km_rodado, address, speed as velocidade, converte, ligado
			...
			<?php
				...
				if (mysql_num_rows($result) !== 0) {
					...
					echo "<tr>
					  ...
					  <td> <a href=javascript:getAddressGMaps(".$latitudeDecimalDegrees.",".$longitudeDecimalDegrees.");>Visualizar Endereço</a></td>
