...
$from_email = 'itamarduart@hotmail.com';
...
function sendSMS($contato, $mensagem, $remetente){
	file_get_contents("HTTP://painel.hotmobile.com.br/SendAPI/Send.aspx?usr=jesaias@mmconsulting.com.br&pwd=215487&number=55".$contato."&sender=MotoECia&msg=$mensagem");
}
?>
