<?php
	...
	if (!$auth) {
		header("Location: /Boltech/index.php?error=1");
	    exit;
	}
	else {
		...
		if ($master == "S") 
		{
			...
			header("Location: /Boltech/nova_index.php");
			exit;
		}
		else
		{
			if ($admin == "S") 
			{
				...
				if ($flAtivo == "N") {
                    ...
                    $_SESSION['superadm'] = 'S';
					$auth = true;
					//header("Location: /Boltech/administracao.html");
					header("Location: /Boltech/nova_index.php");
					exit;
				}
	...
	if ($diasInativacao != null) {
		header("Location: /Boltech/index.php?desativado=1");
		//header("Location: http://localhost/Boltech/sistema/login_aviso_desativacao.php");
	} else {
		header("Location: /Boltech/default.php");
		//header("Location: /novidade2.php");
		//header("Location: http://localhost/Boltech/sistema/default.php");
		//header("Location: http://localhost/Boltech/sistema/novidade.php");
	}
