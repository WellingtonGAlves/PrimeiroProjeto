...
<html lang="pt-BR">
    <head>
        ...
        <!-- Bootstrap CSS -->
        <link href="Boltech/css/bootstrap.min.css" rel="stylesheet" media="screen">
        ...
        <div class="container">
            <div class="login-container col-xs-12 col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                ...
                <div class="form-box">
                    <form>
                    	<h4>
                        	Para sua seguran�a o sistema ir� gerar uma nova senha e enviar para seu e-mail cadastrado.
                            <br><br>
	...
	{		
		$.ajax({
			...
			success: function (response) {			   
			   ...
			   {
				   alert('E-mail n�o encontrado. Por favor verifique ou entre em contato com o suporte.');
				   $("#txtEmail").empty();
